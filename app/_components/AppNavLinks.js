...
function NavLink({ children, href, Icon }) {
  ...
  return (
    <NextLink
      className={`flex items-center hover:text-primary-main/80 justify-start gap-x-[15px] capitalize text-base leading-[188%] font-normal ${
...
export default function Links() {
  return (
    <ul className="flex flex-col items-start gap-y-[16px]">
      ...
      <li>
        <NavLink href="/offline" Icon={OfflineIcon}>
          Offline mode
        </NavLink>
      </li>
      <li>
        <NavLink href="/notifications" Icon={NotificationsIcon}>
          Notifications
        </NavLink>
      </li>
    </ul>
