    ...
    <div className="w-full h-full bg-[#034732] flex flex-col items-center justify-around md:flex-row">
      <div className="w-[50%] flex flex-col items-center justify-center">
        ...
        <p className="text-center text-white text-sm mt-6 md:ml-20">
          Log in to your Farm insight account and pick up right where you left
          off. Your farm's success story continues with real-time insights,
          weather updates, and expert advice. Let's grow together!"
        </p>
      </div>
